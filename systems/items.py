...
class ItemEffect:
    ...
    def apply(self, stats: PlayerStats) -> Dict[str, int]:
        ...
        if self.green_keys != 0:
            old = stats.green_keys
            stats.green_keys = max(0, stats.green_keys + self.green_keys)
            changes['green_keys'] = stats.green_keys - old
        ...
        try:
            ...
            if 'effect' in data:
                effect = ItemEffect(
                    ...
                    green_keys=data['effect'].get('green_keys', 0),
                )
...
def create_default_items() -> Dict[str, ItemData]:
    ...
    return {
        ...
        "green_key": ItemData(
            ...
            item_type=ItemType.KEY,
            description="打开绿色门",
            effect=ItemEffect(green_keys=1),
            price=200,
            sell_price=100,
            stackable=True,
            consumable=False,
        ...
        "master_key": ItemData(
            ...
            name_cn="万能钥匙",
            item_type=ItemType.KEY,
            description="可打开任意颜色的门",
            effect=ItemEffect(yellow_keys=1, blue_keys=1, red_keys=1, green_keys=1),
            price=500,
            sell_price=250,
            stackable=True,
            consumable=True,
        ...
        "green_potion": ItemData(
            id="green_potion",
            name="Green Potion",
            name_cn="绿药水",
            item_type=ItemType.POTION,
            description="恢复1000点HP",
            effect=ItemEffect(hp=1000),
            price=300,
            sell_price=150,
            stackable=True,
            consumable=True,
        ...
        "brown_potion": ItemData(
            id="brown_potion",
            name="Brown Potion",
            name_cn="棕药水",
            item_type=ItemType.POTION,
            description="完全恢复HP",
            effect=ItemEffect(hp=9999),
            price=500,
            sell_price=250,
            stackable=True,
            consumable=True,
        ...
        "green_gem": ItemData(
            ...
            name_cn="绿宝石",
            item_type=ItemType.SPECIAL,
            description="攻击力+5, 防御力+5",
            effect=ItemEffect(attack=5, defense=5),
            price=200,
            sell_price=100,
            stackable=True,
            consumable=True,
